...
class Project(models.Model):
    ...
    tags = models.ManyToManyField('Tag', blank=True) # For many to many Relationship
...
class Review(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE) # For one to many Relationship with Project->Review
